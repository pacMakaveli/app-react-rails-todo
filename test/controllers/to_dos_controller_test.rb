...
class ToDosControllerTest < ActionController::TestCase
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post :create, to_do: { description: @to_do.description, folder_id: @to_do.folder_id, name: @to_do.name, owner_id: @to_do.owner_id }
    end
  ...
  test "should update to_do" do
    patch :update, id: @to_do, to_do: { description: @to_do.description, folder_id: @to_do.folder_id, name: @to_do.name, owner_id: @to_do.owner_id }
    assert_redirected_to to_do_path(assigns(:to_do))
  end
